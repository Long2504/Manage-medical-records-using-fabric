...
function printHelp () {
  ...
  echo "    -c <channel name> - test network channel name (defaults to \"health-management\")"
  ...
  echo "	addOrg3.sh up"
  echo "	addOrg3.sh up -c health-management -s couchdb"
...
#default for delay
CLI_DELAY=3
# channel name defaults to "health-management"
CHANNEL_NAME="health-management"
